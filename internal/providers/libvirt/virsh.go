...
const (
	...
	// VIRTRIGAUD_LIBVIRT_MAX_CONCURRENT_VIRSH.
	// ponytail: fixed cap; the strategic fix (#255/#256) is a persistent libvirt
	// connection, after which this can be raised or removed.
