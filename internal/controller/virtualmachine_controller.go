...
func (r *VirtualMachineReconciler) reconcileVM(ctx context.Context, vm *infravirtrigaudiov1beta1.VirtualMachine) (ctrl.Result, error) {
	...
	// storm on the libvirt host (libvirt-post-adoption-validate-storm
	// investigation). The image-prepare / create RPCs below are themselves the
	// liveness test: a dead provider fails them and the reconcile requeues.
